...
export const metadata: Metadata = {
  ...
  keywords:
    "سدر الجوري، السدر، سدر، jujube، السدر للشعر، فوائد السدر للشعر، ماسك السدر للشعر، عسل السدر، زيت السدر، النبق، شجرة السدر، سدر مطحون، شامبو السدر، ورق السدر، السدر للبشرة، السدر للوجه، sidr, ziziphus, jujube tree, jujube benefits",
  ...
  openGraph: {
    ...
    description:
      "متجر السدر الطبيعي الأول في السعودية. عسل السدر الجبلي، زيت السدر، سدر مطحون ومنتجات طبيعية 100%. Jujube natural products",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
